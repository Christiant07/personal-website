    ...
    return (
        <main>
            ...
            <div className="projects">
                ...
                <br></br>
                <div className="experience">
                    <img src = "https://zfkwhyiovawoxvgxvfbv.supabase.co/storage/v1/object/public/images/screenshot.gif" alt = "Ants vs SomeBees gif" width = {400} height = {200}/>
                    <div className="description">
            ...
            <h2>Work</h2>
            <div className="experience">
                <img src = "https://zfkwhyiovawoxvgxvfbv.supabase.co/storage/v1/object/public/images/IMG_8942.jpeg" alt = "picture with colleagues" width = {220} height = {260}/>
                <div className="description">
